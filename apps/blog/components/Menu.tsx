import { Box, Flex, Logo, ThemeSwitcher, Link, Button, LangSelector } from '@simpleflow/uikit'
import { useTheme as useNextTheme } from 'next-themes'
import { useTranslation, languageList } from '@simpleflow/l10n'
    ...
    <Flex height="56px" bg="backgroundAlt" px="16px" alignItems="center" justifyContent="space-between" zIndex={9}>
      ...
      <Flex alignItems="center">
        ...
        <LangSelector
          ...
          setLang={setLanguage}
        />
        <Link external href="https://simpleflow.finance/">
