...
import { Box, Flex, IfoSkeletonCardDetails, Skeleton, Text, TooltipText, useTooltip } from '@simpleflow/uikit'
import { formatNumber, getBalanceNumber } from '@simpleflow/utils/formatBalance'
import { DAY_IN_SECONDS } from '@simpleflow/utils/getTimePeriods'
