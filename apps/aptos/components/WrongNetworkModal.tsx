import { useDisconnect } from '@simpleflow/awgmi'
import { useTranslation } from '@simpleflow/l10n'
import { Button, HelpIcon, Link, Message, MessageText, Modal, ModalV2, Text } from '@simpleflow/uikit'
  ...
  return (
    <ModalV2 isOpen={isWrongNetwork}>
      <Modal title={t('Wrong Network')} hideCloseButton>
        ...
        <StyledLink
          href="https://docs.simpleflow.finance/get-started-aptos/connection-guide#connect-to-aptos-mainnet"
          external
        >
