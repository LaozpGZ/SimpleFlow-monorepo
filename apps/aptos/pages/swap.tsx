import {
  ...
  Trade,
  TradeType,
} from '@simpleflow/aptos-swap-sdk'
import { useAccount } from '@simpleflow/awgmi'
import { SimulateTransactionError, UserRejectedRequestError, parseVmStatusError } from '@simpleflow/awgmi/core'
...
import { Swap as SwapUI, useAsyncConfirmPriceImpactWithoutFee } from '@simpleflow/widgets-internal'
import { useQuery } from '@tanstack/react-query'

import replaceBrowserHistoryMultiple from '@simpleflow/utils/replaceBrowserHistoryMultiple'
import tryParseAmount from '@simpleflow/utils/tryParseAmount'
import { useUserSlippage } from '@simpleflow/utils/user'
import { useIsExpertMode } from '@simpleflow/utils/user/expertMode'
