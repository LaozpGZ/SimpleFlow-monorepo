import { Box, DropdownMenu, DropdownMenuItemType, Flex, Logo, ThemeSwitcher } from '@simpleflow/uikit'
...
const MenuConfig = [
  ...
  {
    title: 'EVMs',
    href: 'https://simpleflow.finance/bridge',
  },
]
...
export function Menu() {
  ...
  return (
    <Flex height="56px" bg="backgroundAlt" px="16px" alignItems="center" justifyContent="space-between" zIndex={9}>
      <Flex>
        <Logo href="https://simpleflow.finance" />
        ...
        <Flex pl={['10px', null, '50px']}>
          ...
          <a href="https://simpleflow.finance/swap" target="_blank" rel="noreferrer noopener">
