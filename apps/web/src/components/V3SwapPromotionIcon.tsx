      ...
      <ColoredIconButton className="is-shining" variant="text" scale="sm">
        ...
        >
          <Text
            ...
            onClick={() => {
              window.open(
                'https://blog.simpleflow.finance/articles/participate-in-pancake-swap-v3-launch-claim-135-k-cake-airdrop-and-receive-an-exclusive-nft-for-early-supporters',
                '_blank',
                'noreferrer noopener',
              )
            }}
