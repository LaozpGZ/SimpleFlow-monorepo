...
import { Currency, CurrencyAmount, Pair, Percent } from '@simpleflow/sdk'
import { Text, Card, CardBody, Flex, CardProps, TooltipText, useTooltip, Link, AutoColumn } from '@simpleflow/uikit'
                ...
                <Trans
                  ...
                  components={[
                    <Link
                      ...
                      ml="4px"
                      external
                      href="https://docs.simpleflow.finance/products/stableswap#stableswap-fees"
                    />,
                  ]}
                />
              </>
