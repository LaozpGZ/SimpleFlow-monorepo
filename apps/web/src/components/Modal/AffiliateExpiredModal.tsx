...
export function AffiliateExpiredModal() {
  ...
  const [onOptionsConfirmModalPresent] = useModal(
    <DisclaimerModal
      ...
      bodyMaxHeight="80vh"
      modalHeader={t('SimpleFlow Affiliate Program')}
      header={
        <>
          ...
          <Text mt="1.5rem">
            {t(
              `Please be informed that the Affiliate who referred you and through whose referral link you signed up to trade is no longer part of SimpleFlow's Affiliate Program. As a result, effective immediately %time%, you will no longer receive any trading discounts from this Affiliate if they were previously enabled.`,
              {
                time: '5 Sep 2024',
              },
            )}
