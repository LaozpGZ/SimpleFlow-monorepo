...
import { Button, Text, Link, HelpIcon, Message, MessageText } from '@simpleflow/uikit'
...
const WalletWrongNetwork: React.FC<React.PropsWithChildren<WalletWrongNetworkProps>> = ({ onDismiss }) => {
  ...
  return (
    <>
      ...
      <StyledLink href="https://docs.simpleflow.finance/get-started/connection-guide" external>
