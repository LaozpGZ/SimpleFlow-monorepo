import { useTranslation, TranslateFunction } from '@simpleflow/l10n'
import { styled } from 'styled-components'
import { Card, Flex, Box, InfoIcon, Text, useTooltip } from '@simpleflow/uikit'
...
import { AVERAGE_CHAIN_BLOCK_TIMES, ChainId, chainNames, getChainName } from '@simpleflow/chains'
