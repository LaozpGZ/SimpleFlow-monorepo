...
export function useTradeVerifiedByQuoter<P extends Params>(p: P): P {
  ...
  const serializableTrade = useMemo(() => trade && InfinityRouter.Transformer.serializeTrade(trade), [trade])
      ...
      return {
        ...
        routes: trade.routes.map((r, index) => {
          ...
          return {
            ...
            ...(hasVerifiedQuote
              ? reviseGasUseEstimate(trade.tradeType, r, quotes[quotePosition]!.gasUseEstimate)
              : {}),
          }
        }),
