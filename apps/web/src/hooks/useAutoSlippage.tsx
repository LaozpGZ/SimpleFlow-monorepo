...
import { Percent, TradeType } from '@simpleflow/sdk'
import { InfinityRouter, SmartRouterTrade } from '@simpleflow/smart-router'
...
import { BridgeTrade } from '@simpleflow/price-api-sdk'
