    ...
    description: [
      <ul key="benefits-list">
        <li>
          ...
          <InlineLink
            href="https://docs.simpleflow.finance/products/vecake/earn-cake-weekly"
            target="_blank"
            rel="noreferrer"
          >
        ...
        <li>
          ...
          <InlineLink
            href="https://docs.simpleflow.finance/products/ifo-initial-farm-offering"
            target="_blank"
            rel="noreferrer"
          >
            <Trans>More details here</Trans>
  ...
  },
  {
    ...
    description: [
      <>
        ...
        <InlineLink
          href="https://docs.simpleflow.finance/products/vecake/bridge-your-vecake"
          target="_blank"
          rel="noreferrer"
        >
