...
import { Currency, CurrencyAmount, Price, Token } from '@simpleflow/swap-sdk-core'
import { PairDataTimeWindowEnum, UseModalV2Props } from '@simpleflow/uikit'
import { encodeSqrtRatioX96, parseProtocolFees, TickMath } from '@simpleflow/v3-sdk'
import { RoiCalculatorModalV2 } from '@simpleflow/widgets-internal/roi'
