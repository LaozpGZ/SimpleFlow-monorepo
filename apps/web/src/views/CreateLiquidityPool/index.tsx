...
import { ArrowForwardIcon, Box, Card, CardBody, Container, FlexGap, LinkExternal, Text } from '@simpleflow/uikit'
          ...
          <Card>
            <CardBody>
              <FlexGap justifyContent="space-between" flexWrap="wrap" gap="16px">
                ...
                <LinkExternal color="primary60" href="https://docs.simpleflow.finance/earn/pancakeswap-pools">
                  {t('Learn More')}
                </LinkExternal>
              </FlexGap>
