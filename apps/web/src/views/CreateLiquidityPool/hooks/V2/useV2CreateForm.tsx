...
import { useIsExpertMode, useUserSlippage } from '@simpleflow/utils/user'
...
import { Currency, CurrencyAmount, Pair, Price, Token } from '@simpleflow/sdk'
        ...
        {isOneWeiAttack ? (
          <Message variant="warning">
            <Flex flexDirection="column">
              ...
              <LinkExternal
                href="https://docs.simpleflow.finance/products/pancakeswap-exchange/faq#why-cant-i-add-liquidity-to-a-pair-i-just-created"
                mt="0.25rem"
              >
