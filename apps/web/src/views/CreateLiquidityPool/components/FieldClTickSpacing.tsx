import { MAX_TICK_SPACING, MIN_TICK_SPACING } from '@simpleflow/infinity-sdk'
import { useTranslation } from '@simpleflow/l10n'
import { Box, BoxProps, FlexGap, Input, PreTitle, QuestionHelper, Text } from '@simpleflow/uikit'
