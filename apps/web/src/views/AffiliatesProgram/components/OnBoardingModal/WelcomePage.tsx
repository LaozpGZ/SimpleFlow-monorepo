import { Flex, Box, Text, Button, LogoRoundIcon, Checkbox, Link } from '@simpleflow/uikit'
          ...
          <Flex alignItems="center">
            ...
            <Text fontSize="14px" ml="8px">
              ...
              <Text display="inline-block" as="span" ml="4px">
                <Link external href="https://docs.simpleflow.finance/affiliate-program/terms-and-conditions">
