import { Box, Button, Flex, Heading, LinkExternal, PageHeader, PageSection } from '@simpleflow/uikit'
  ...
  return (
    <>
      ...
      <Gradient p="64px 0">
        ...
        <LinkExternal
          href="https://docs.simpleflow.finance/ecosystem-and-partnerships/business-partnerships/nft-market-applications"
          mx="auto"
          mt="16px"
        >
