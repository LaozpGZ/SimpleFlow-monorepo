...
export const useBridgeErrorMessages = () => {
  ...
  const messages = {
    ...
    tokenNotSupported: t("This token isn't supported. Please select a different token."),
    insufficientAmount: t('Retry with higher input amount!'),
    insufficientBalance: t('Insufficient balance. Please check your wallet balance.'),
    noRoutes: t('No route available for this swap. Please try a different token pair.'),
