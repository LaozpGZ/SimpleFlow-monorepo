...
import { Currency, CurrencyAmount, Percent, TradeType } from '@simpleflow/sdk'
import { AutoColumn, Button, ErrorIcon, Text } from '@simpleflow/uikit'
...
import { DualCurrencyDisplay } from '@simpleflow/widgets-internal'
