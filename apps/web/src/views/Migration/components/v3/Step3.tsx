...
export function Step3() {
  ...
  return (
    <AtomBox textAlign="center">
      ...
      <Text pb="48px">
        {t(
          'In SimpleFlow Exchange V3, liquidity providers are able to customize the trading fee tier and concentrate their liquidity to a specific price range to maximize their capital efficiency.',
        )}
      </Text>
