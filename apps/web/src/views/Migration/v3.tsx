        ...
        <RowBetween flexWrap="nowrap">
          ...
          >
            ...
            <AutoColumn gap="4px" pt="4px">
              <Link href="https://docs.simpleflow.finance/code/v3-migration/how-to-migrate" external>
              ...
              <Link href="https://docs.simpleflow.finance/code/v3-migration/faq" external>
                <Button p="0" variant="text" scale="sm">
                  <Text color="primary" bold fontSize="16px" mr="4px">
                    {t('Need help ?')}
                  </Text>
