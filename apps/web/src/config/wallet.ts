...
import { WalletFilledIcon } from '@simpleflow/uikit'
import safeGetWindow from '@simpleflow/utils/safeGetWindow'
import { getTrustWalletProvider } from '@simpleflow/wagmi/connectors/trustWallet'
...
export const TOP_WALLET_MAP: { [chainId: number]: LegacyWalletIds[] } = {
  ...
  [ChainId.SIMPLECHAIN]: [LegacyWalletIds.Metamask, LegacyWalletIds.Okx, LegacyWalletIds.Walletconnect],
}
