...
const SIMPLECHAIN_TESTNET_RPC_URLS = ['https://rpc-testnet.simplechain.network'].filter(Boolean)
...
export const PUBLIC_NODES: Partial<Record<ChainId, readonly string[]>> = {
  [ChainId.SIMPLECHAIN]: SIMPLECHAIN_RPC_URLS as readonly string[],
  [ChainId.SIMPLECHAIN_TESTNET]: SIMPLECHAIN_TESTNET_RPC_URLS as readonly string[],
  [ChainId.ETHEREUM]: [
