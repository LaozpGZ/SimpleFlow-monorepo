...
import { Box, Text, useToast } from '@simpleflow/uikit'
...
import { AVERAGE_CHAIN_BLOCK_TIMES, NonEVMChainId } from '@simpleflow/chains'
import { BSC_BLOCK_TIME } from 'config'
import { useFetchBlockData } from '@simpleflow/wagmi'
