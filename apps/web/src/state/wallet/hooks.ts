import { ChainId, Currency, CurrencyAmount, Native, Token, UnifiedCurrency, ZERO_ADDRESS } from '@simpleflow/sdk'
import { useQuery } from '@tanstack/react-query'
import { isSolana, NonEVMChainId } from '@simpleflow/chains'
import { selectedEvmWalletAtom, selectedSolanaWalletAtom } from '@simpleflow/ui-wallets/src/state/atom'
import useAccountActiveChain from 'hooks/useAccountActiveChain'
import { useLocalStorage, useWallet } from '@solana/wallet-adapter-react'
import { SolanaProviderLocalStorageKey, WalletAdaptedNetwork } from '@simpleflow/ui-wallets'
