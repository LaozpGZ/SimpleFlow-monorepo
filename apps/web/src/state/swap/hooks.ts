import { Currency, Native, SOL, Trade, TradeType, UnifiedNativeCurrency } from '@simpleflow/sdk'
import { CAKE, STABLE_COIN, USDC, USDT } from '@simpleflow/tokens'
import { PairDataTimeWindowEnum } from '@simpleflow/uikit'
import { isAptos, NonEVMChainId, UnifiedChainId } from '@simpleflow/chains'
