...
export const useActiveChainId = () => {
  ...
  const chainId = localChainId ?? wagmiChainId ?? (queryChainId >= 0 ? ChainId.SIMPLECHAIN : undefined)
  ...
  return {
    chainId: chainId && isChainSupported(chainId) ? chainId : ChainId.SIMPLECHAIN,
    isWrongNetwork,
    isNotMatched,
  }
}
