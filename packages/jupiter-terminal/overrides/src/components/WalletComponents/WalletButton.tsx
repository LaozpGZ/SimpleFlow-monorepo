  ...
  if ((!connected && !connecting) || !base58) {
    return (
      <UnifiedWalletButton
        ...
        overrideContent={<WalletModalButton setIsWalletModalOpen={setIsWalletModalOpen} />}
      />
    )
  }

  return (
    <div className="cursor-pointer relative pcs-wallet-btn">
      ...
      {screen === 'Initial' ? (
        <ul
          ...
          className={active ? 'absolute block top-10 right-0 text-sm rounded-lg p-2 pcs-dropdown-list' : 'hidden'}
          ref={ref}
          role="menu"
        >
