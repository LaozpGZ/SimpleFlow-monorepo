...
export const FACTORY_ADDRESSES = {
  ...
  [ChainId.MONAD_MAINNET]: '0xac3695E50cDc22941cffcBBE817EF2c7d7ef4AA5', // SimpleChain
  [ChainId.MONAD_TESTNET]: '0xac3695E50cDc22941cffcBBE817EF2c7d7ef4AA5', // SimpleChain
...
export const DEPLOYER_ADDRESSES = {
  ...
  [ChainId.MONAD_MAINNET]: '0x9E04B69a17f4Ce1AC05600EF3bEf66eF423E455d', // SimpleChain
  [ChainId.MONAD_TESTNET]: '0x9E04B69a17f4Ce1AC05600EF3bEf66eF423E455d', // SimpleChain
} as const satisfies Record<ChainId, Address>
...
export const POOL_INIT_CODE_HASHES = {
  ...
  [ChainId.MONAD_MAINNET]: '0x2485b4b8c1eb9eba7259fb706aa57ea101810c610dec7a2c4ec0c47cbc2e9395', // SimpleChain
  [ChainId.MONAD_TESTNET]: '0x2485b4b8c1eb9eba7259fb706aa57ea101810c610dec7a2c4ec0c47cbc2e9395', // SimpleChain
...
export const NFT_POSITION_MANAGER_ADDRESSES = {
  ...
  [ChainId.MONAD_MAINNET]: '0x53074FeB375dD50b600c9986180ab90974112284', // SimpleChain
  [ChainId.MONAD_TESTNET]: '0x53074FeB375dD50b600c9986180ab90974112284', // SimpleChain
} as const satisfies Record<ChainId, Address>
