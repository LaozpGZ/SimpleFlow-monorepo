...
export const MIXED_ROUTE_QUOTER_ADDRESSES = {
  ...
  [ChainId.SIMPLECHAIN]: '0xA88cE47B8e9eF10591Be79793ccBA2C9d04866c5', // SimpleChain Quoter
  [ChainId.SIMPLECHAIN_TESTNET]: '0xA88cE47B8e9eF10591Be79793ccBA2C9d04866c5', // SimpleChain Quoter
...
export const V3_QUOTER_ADDRESSES = {
  ...
  [ChainId.SIMPLECHAIN]: '0x06B24ED37b44719d64d0b564e9FE4a4914B8B64A', // SimpleChain QuoterV2
  [ChainId.SIMPLECHAIN_TESTNET]: '0x06B24ED37b44719d64d0b564e9FE4a4914B8B64A', // SimpleChain QuoterV2
} as const satisfies Record<ChainId, Address>
...
export const V3_TICK_LENS_ADDRESSES = {
  ...
  [ChainId.SIMPLECHAIN]: '0x64272699d818646781a4fCAa435C98A05b2d9668', // SimpleChain TickLens
  [ChainId.SIMPLECHAIN_TESTNET]: '0x64272699d818646781a4fCAa435C98A05b2d9668', // SimpleChain TickLens
} as const satisfies Record<ChainId, Address>
