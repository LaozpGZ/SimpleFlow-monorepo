import { Currency, CurrencyAmount, Pair, ZERO } from '@simpleflow/sdk'
import { Pool as V3Pool, TickList } from '@simpleflow/v3-sdk'
import { getQuoteExactIn, getQuoteExactOut } from '@simpleflow/stable-swap-sdk'
import {
  Pool as IPool,
  Pool,
  QuoteProvider,
