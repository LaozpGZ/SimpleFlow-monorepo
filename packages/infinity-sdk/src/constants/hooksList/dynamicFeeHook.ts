...
export const CL_DYNAMIC_FEE_HOOK_REGISTRATION_BITMAP = {
  [ChainId.SIMPLECHAIN]: '0x00C2',
  [ChainId.SIMPLECHAIN_TESTNET]: '0x0042',
...
export const CL_DYNAMIC_FEE_HOOKS_BY_CHAIN: { [key in InfinitySupportedChains]: Address } = {
  [ChainId.SIMPLECHAIN]: '0x32C59D556B16DB81DFc32525eFb3CB257f7e493d',
  [ChainId.SIMPLECHAIN_TESTNET]: '0xEce0656EeFA49C16a98447807f62714496aef518',
...
export const BIN_DYNAMIC_FEE_HOOKS_BY_CHAIN: { [key in InfinitySupportedChains]: Address } = {
  ...
  [ChainId.SIMPLECHAIN_TESTNET]: '0x870c167eFCEEaDd081EE783Af8c5c7b436f1d3Ce',
