...
export const getWalletsConfig = ({
  ...
  const wallets = [
    ...
    },
    {
      ...
      connectorId: SolanaWalletNames.BitPie,
      solanaAdapterName: SolanaWalletNames.BitPie,
      networks: [WalletAdaptedNetwork.Solana],
      get installed() {
        return isSolanaWalletInstalled(SolanaWalletNames.BitPie)
      },
      downloadLink: 'https://bitpiecn.com',
    },
    {
      id: WalletIds.BitGet,
      title: 'BitGet',
    ...
    },
    {
      ...
      connectorId: SolanaWalletNames.Solong,
      solanaAdapterName: SolanaWalletNames.Solong,
      networks: [WalletAdaptedNetwork.Solana],
      get installed() {
        return isSolanaWalletInstalled(SolanaWalletNames.Solong)
      },
      downloadLink: 'https://solongwallet.io',
    },
    {
      id: WalletIds.Torus,
      title: 'Torus',
      ...
      connectorId: SolanaWalletNames.Torus,
      solanaAdapterName: SolanaWalletNames.Torus,
      networks: [WalletAdaptedNetwork.Solana],
      get installed() {
        return isSolanaWalletInstalled(SolanaWalletNames.Torus)
      },
      downloadLink: 'https://tor.us',
    },
  ] as WalletConfigV3[]
...
export const TOP_WALLETS_ID_CONFIG = {
  MultiChain: [WalletIds.Metamask, WalletIds.Okx],
