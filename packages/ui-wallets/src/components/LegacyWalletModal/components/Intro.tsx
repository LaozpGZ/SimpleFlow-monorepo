...
import { AtomBox, Button, Heading, Image, LinkExternal, Text } from '@simpleflow/uikit'
...
const IntroSteps = [
  {
    ...
    icon: 'https://cdn.simpleflow.finance/wallets/wallet_intro.png',
    description: (
      <Trans>
  ...
  },
  {
    ...
    icon: 'https://cdn.simpleflow.finance/wallets/world_lock.png',
    description: (
      <Trans>
