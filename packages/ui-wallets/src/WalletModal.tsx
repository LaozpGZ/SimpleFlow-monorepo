      ...
      <AtomBox display="flex" flexDirection="column" gap="16px" justifyContent="space-between">
        <Button variant="tertiary" onClick={onOpenSocialLoginModal} width="100%" style={{ marginBottom: '8px' }}>
          <FlexGap gap="8px" width="100%" justifyContent="center" alignItems="center">
            <img src={`${ASSET_CDN}/web/wallets/social-login/google.jpg`} width="20" height="20" alt="Google" />
            <img src={`${ASSET_CDN}/web/wallets/social-login/apple.png`} width="20" height="20" alt="Apple" />
            <img src={`${ASSET_CDN}/web/wallets/social-login/facebook.png`} width="20" height="20" alt="Facebook" />
            <Text>{t('Connect with social login')}</Text>
    ...
    <>
      ...
      >
        ...
        <Button variant="tertiary" onClick={onOpenSocialLoginModal} width="100%">
          <FlexGap gap="8px" width="100%" justifyContent="center" alignItems="center">
            <img src="https://cdn.pancakeswap.com/wallets/google.svg" width="20" height="20" alt="Google" />
            <img src="https://cdn.pancakeswap.com/wallets/apple.svg" width="20" height="20" alt="Apple" />
            <img src="https://cdn.pancakeswap.com/wallets/facebook.svg" width="20" height="20" alt="Facebook" />
            <Text>{t('Connect with social login')}</Text>
            <ChevronRightIcon color="primary" />
          </FlexGap>
        </Button>
...
export function WalletModalV2<T = unknown>(props: WalletModalV2Props<T>) {
  ...
  return (
    <>
      <Suspense>
        <SocialLoginModal isOpen={isSocialLoginModalOpen} onDismiss={handleCloseSocialLoginModal} />
      </Suspense>
