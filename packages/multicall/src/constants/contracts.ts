...
export const MULTICALL_ADDRESS: { [key in ChainId]?: Address } = {
  [ChainId.SIMPLECHAIN]: '0xC005b39086AF12248eA2507C22b0e38f0463a79b',
  ...
  [ChainId.LINEA_TESTNET]: '0xC005b39086AF12248eA2507C22b0e38f0463a79b', // Using SimpleChain Testnet address
...
export const MULTICALL3_ADDRESSES: {
  ...
  [ChainId.SIMPLECHAIN]: MULTICALL3_ADDRESS,
  ...
  [ChainId.LINEA_TESTNET]: MULTICALL3_ADDRESS, // Using standard Multicall3 address
}
