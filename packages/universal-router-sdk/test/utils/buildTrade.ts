import { Currency, CurrencyAmount, ERC20Token, Native, Pair, TradeType, Trade as V2Trade } from '@simpleflow/sdk'
import {
  Pool as GenericPool,
  InfinityBinPool,
  InfinityClPool,
...
import { Pool, Trade as V3Trade } from '@simpleflow/v3-sdk'
